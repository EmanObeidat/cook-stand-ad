...
export default function Table({ addCookies ,deleteHandeler}) {
  const timeSlots = [
...
<td className='bg-green-600 border border-black'>
                  ...
                  <svg onClick={() => deleteHandeler(obj.id)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" style={{ verticalAlign: 'middle', cursor: 'pointer' }}>
